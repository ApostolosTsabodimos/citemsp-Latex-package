...
\begin{itemize}[leftmargin=2em]
  ...
  \item \textbf{Custom prefixes:} register new locator types with
    \verb|\citemspprefix{letter}{label}|. The letter must be a single
    character not already in use. Custom and built-in prefixes can be
    freely mixed in the same \cmd{citemsp} call.
\end{itemize}
